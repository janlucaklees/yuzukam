<script lang="ts">
	import { BatteryFull } from 'svelte-ionicons';
...
<div class="battery-indicator">
	...
	{:else }
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			<rect x="32" y="144" width="400" height="224" rx="45.7" ry="45.7" style="fill:none;;stroke-linecap:square;stroke-miterlimit:10;stroke-width:32px"/>
			<rect x="69.69" y="182.93" width="{(292.63 + 32) * level}" height="146.14" rx="20" ry="20" style=""/>
			<line x1="480" y1="218.67" x2="480" y2="293.33" style="fill:none;;stroke-linecap:round;stroke-miterlimit:10;stroke-width:32px"/>
		</svg>
	{/if}
</div>
